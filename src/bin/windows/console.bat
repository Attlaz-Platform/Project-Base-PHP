...
REM docker run --rm -it --init -v %cd%:/var/attlaz -w /var/attlaz hq.attlaz.com:2498/php8_1:1.0.0 bin/console %*
docker run --rm -it --init -v %cd%:/var/attlaz -w /var/attlaz attlaz/php:8.1 bin/console %*
